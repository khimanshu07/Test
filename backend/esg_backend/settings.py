...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-2r7i4-2tn5lnrrhwk6ytspjf(meh=pnh-n+e)n2l6n8w9gdz#=')
...
# Database
# Supports environment-based configuration for PostgreSQL, fallbacks to SQLite
